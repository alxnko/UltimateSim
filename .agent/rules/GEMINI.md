...
## 📚 THE SINGLE SOURCE OF TRUTH (DOCUMENTATION)
...
These files must be treated as the ultimate instruction set and single source of truth for all implementations and reasoning tasks.
